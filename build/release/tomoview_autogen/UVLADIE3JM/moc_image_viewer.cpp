...
Q_CONSTINIT static const qt_meta_stringdata_ImageViewer_t qt_meta_stringdata_ImageViewer = {
    {
        ...
        QT_MOC_LITERAL(12, 18),  // "toggle_save_option"
        QT_MOC_LITERAL(31, 0),  // ""
        QT_MOC_LITERAL(32, 2)   // "sw"
    },
    "ImageViewer",
    "toggle_save_option",
    "",
...
void ImageViewer::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->toggle_save_option((*reinterpret_cast< std::add_pointer_t<bool>>(_a[1]))); break;
        default: ;
        }
    }
}
