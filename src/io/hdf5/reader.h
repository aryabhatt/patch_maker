    ...
    namespace h5 {
        class Reader {
          ...
          public:
             ...
             */
            template <typename T>
            Array<T> read_sinogram(const char *dataset, hsize_t begin = 0,
                hsize_t end = -1) {
                ...
                Array<T> A({(int)dims[0], (int)nslice, (int)dims[2]});
                ...
                Array<T> B({(int)nslice, (int)dims[0], (int)dims[2]});
...
#pragma omp parallel for
            ...
            template <typename T>
            Array<T> read2(const char *dataset, int begin = 0, int end = -1) {
                ...
                hid_t out_space = H5Screate_simple(3, out_dims, NULL);
                Array<T> A({(int)nslice, (int)dims[1], (int)dims[2]});
